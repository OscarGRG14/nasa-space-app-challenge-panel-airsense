...
export default function Hero({ data }) {
    return (
        <div className="relative flex flex-col items-center justify-center bg-transparent mb-6">
            ...
            <h2 className="text-2xl text-white mb-1">Distrito: {data.location.department}</h2>
            <p className="text-xl text-white">Ciudad: {data.location.city}</p>
            <p className="text-lg text-white">Pais: {data.location.country}</p>
